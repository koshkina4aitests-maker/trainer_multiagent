...
class LocalStorage {
  ...
  Future<void> setUserName(String name) => _prefs.setString(_keyUserName, name.trim());
  ...
  String? get trainingStyle => _prefs.getString(_keyTrainingStyle);
  Future<void> setTrainingStyle(String style) =>
      _prefs.setString(_keyTrainingStyle, style);
